...
create table if not exists public.agent_nodes (
  id text primary key default gen_random_uuid()::text,
  role text not null check (role in ('orchestrator', 'market_bias', 'scanner', 'research', 'chart_vision', 'analyst', 'critic', 'intel', 'publisher', 'memory', 'monitor')),
...
create table if not exists public.signals (
  ...
  trading_style text check (trading_style in ('day_trade', 'swing_trade')),
...
create table if not exists public.agent_events (
  ...
  agent_role text not null check (agent_role in ('orchestrator', 'market_bias', 'scanner', 'research', 'chart_vision', 'analyst', 'critic', 'intel', 'publisher', 'memory', 'monitor')),
...
create table if not exists public.axl_messages (
  ...
  from_role text not null check (from_role in ('orchestrator', 'market_bias', 'scanner', 'research', 'chart_vision', 'analyst', 'critic', 'intel', 'publisher', 'memory', 'monitor')),
  to_agent_id text references public.agent_nodes(id) on delete set null,
  to_role text check (to_role in ('orchestrator', 'market_bias', 'scanner', 'research', 'chart_vision', 'analyst', 'critic', 'intel', 'publisher', 'memory', 'monitor')),
  topic text,
