...
export const buildIntelSystemPrompt = (input: z.input<typeof intelPromptContextSchema>) => {
  ...
  return [
    ...
    "   - Prefer a specific market-news narrative over SKIP when current X/web context contains a coherent story.",
    "   - Do not frame rejected trade candidates as watchlist setups. Intel is market news, narrative, and context only.",
    "",
