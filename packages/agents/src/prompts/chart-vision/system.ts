...
export const buildChartVisionSystemPrompt = (
  ...
  return [
    ...
    '{"frames":[{"timeframe":"15m","analysis":"Price is compressing near local resistance with no clean breakout."}],"summary":"The visible chart structure is range-bound and does not confirm a directional trade."}',
    "Every frame must include only timeframe and analysis.",
    "The top-level summary field is required.",
