...
export default function Home() {
    ...
    const features = [
        ...
        },
        {
            ...
            description: 'The entire system is completely free to use. No token-gating, no premium tiers. Just pure alpha delivered instantly to everyone.',
            icon: Shield02Icon,
            stats: [
            ...
            <section id="features" className="py-32 relative bg-noir-black overflow-hidden">
                ...
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="text-center mb-20">
                        ...
                        >
                            Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-glow to-teal-500">Omen</span>?
                        </motion.h2>
                        <motion.p
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                        ...
                        <div className="lg:col-span-4 flex flex-col gap-4">
                            {features.map((feature, index) => (
                                ...
                                >
                                    <div className={`absolute left-0 top-0 bottom-0 w-1 transition-colors duration-300 ${activeFeature === index ? 'bg-teal-glow' : 'bg-transparent group-hover:bg-white/20'
                                        }`} />
                    ...
                    <div className="relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
                            {[
                                ...
                                { step: '02', title: 'Free Access', desc: 'System grants unrestricted access. No token-gating or premium tiers required.', icon: Shield02Icon },
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <h2 className="text-5xl md:text-7xl font-bold mb-8 text-white tracking-tight leading-tight">
                                Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-glow to-white">Enter Omen</span>?
                            </h2>
