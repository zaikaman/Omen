...
export default function Home() {
    ...
    const [stats] = useState([
        { label: 'AGENT ROLES', value: '10', change: 'AXL' },
        { label: 'PEER NODES', value: '12', change: 'LIVE' },
        { label: 'PROOF LAYERS', value: '6+', change: '0G' },
        { label: 'RUN CADENCE', value: '1H', change: 'AUTO' },
    ])
    ...
    const features = [
        {
            ...
            description: 'Ten role agents coordinate through a live AXL network, with scanner, research, chart vision, analyst, critic, intel, writer, and publisher responsibilities kept separate.',
        ...
        },
        {
            ...
            description: 'Trade setups include entry, targets, stop loss, confidence, and risk context, then pass through adversarial critic review before publication.',
            icon: FlashIcon,
            stats: [
                { label: 'GATES', value: 'CRITIC' },
        ...
        },
        {
            ...
            description: 'Each completed run can produce storage artifacts, state checkpoints, compute review, manifests, and on-chain anchors that make outputs inspectable.',
            icon: Shield02Icon,
            stats: [
                { label: 'STORAGE', value: '0G' },
                { label: 'ANCHOR', value: 'CHAIN' }
            ]
        },
        {
            id: '04',
            title: 'Narrative Intelligence',
            description: 'When no signal clears the gates, the swarm still turns market, DeFi, and social context into long-form intel with source-aware evidence.',
            icon: Analytics01Icon,
            stats: [
                { label: 'OUTPUT', value: 'REPORT' },
                { label: 'STATUS', value: 'PROOFED' }
            ]
        }
    ];
            ...
            <section id="features" className="py-32 relative bg-noir-black overflow-hidden">
                ...
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="text-center mb-20">
                        ...
                        >
                            Omen is built to show its work: separate AXL agent nodes, critic-reviewed outputs, and 0G proof artifacts behind each completed run.
                        </motion.p>
                    </div>
                        ...
                        <div className="lg:col-span-4 flex flex-col gap-4">
                            {features.map((feature, index) => (
                                <button
                                    ...
                                    className={`group relative p-6 rounded-2xl border text-left transition-all duration-300 overflow-hidden ${activeFeature === index
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <span className={`font-mono text-sm ${activeFeature === index ? 'text-teal-glow' : 'text-gray-600'
                                            }`}>
                                            {feature.id}
                                        </span>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-12 lg:gap-12 items-center">
                            <div className="flex flex-col justify-between h-full">
                                <div>
                                    ...
                                    >
                                        From agent routing to proof-backed output.
                                    </motion.h2>
            ...
            <section id="how-it-works" className="py-32 relative bg-noir-black overflow-hidden">
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="text-center mb-24">
                        ...
                        >
                            Establish uplink to the Omen network in three stages.
                        </motion.p>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
                            {[
                                { step: '01', title: 'Inspect Live Runs', desc: 'Open the dashboard to see latest signals, intel, traces, and proof records from completed swarm runs.', icon: FlashIcon },
                                { step: '02', title: 'Verify The Route', desc: 'Review AXL topology, peer services, delegated steps, and message traces to confirm agent coordination.', icon: Shield02Icon },
                                { step: '03', title: 'Follow The Proof', desc: 'Open evidence bundles, compute records, manifests, and chain anchors for the output you are evaluating.', icon: Analytics01Icon },
                            ].map((item, i) => (
                                <motion.div
                                    key={i}
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
                                Inspect live runs, agent traces, proof artifacts, signals, and intel from the Omen dashboard.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                                ...
                                <a href="#top" className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 text-white border border-white/10 px-12 py-6 rounded-xl text-xl font-bold transition-all duration-300 backdrop-blur-sm hover:border-teal-glow/30">
                    ...
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        <div className="col-span-1 md:col-span-1">
                            ...
                            <p className="text-sm text-gray-500 leading-relaxed">
                                Verifiable market intelligence from an autonomous agent swarm.
                            </p>
                        </div>
                        <div>
